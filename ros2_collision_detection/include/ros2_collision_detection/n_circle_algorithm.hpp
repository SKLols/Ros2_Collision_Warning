...
//#ifndef ROS2_COLLISION_DETECTION__N_CIRCLE_ALGORITHM_HPP
//#define ROS2_COLLISION_DETECTION__N_CIRCLE_ALGORITHM_HPP
//
...
//
//class NCircleAlgorithm : public ros2_collision_detection::TTCAlgorithm
//{
//private:
//    /**
...
//     * @return The coordinate of the front bumper center.
//     */
...
//     * @param factor How many times part_length the circle center will be away from the front bumper center. 
//     * @param trigonometric_value The trigonometric value from a trigonometric function.
...
//
//    /**
//     * @brief Compute the radius of the n circles for an object with length and width.
//     * 
...
//}  // namespace ros2_collision_detection_plugins
//
//#endif // ROS2_COLLISION_DETECTION__N_CIRCLE_ALGORITHM_HPP